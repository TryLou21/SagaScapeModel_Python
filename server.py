...
# from simulation import SAGAscapeModel  # jouw modelklasse
...
#     """
#     Definieert hoe elke agent getekend moet worden in de CanvasGrid.
#     """
#     if isinstance(agent, CommunityAgent):
#         # Weergave voor de CommunityAgent
#         return {
#             "Shape": "circle",
#             "Color": "red",
#             "Filled": "true",
#             "Layer": 1,  # Hogere laag, zodat de community over de patch wordt getekend
#             "r": 0.8
#         }
#     elif isinstance(agent, PatchAgent):
#         # Weergave voor de PatchAgent
#         # Laten we de Patch-agenten kleuren op basis van hun 'wood_standingStock'
#         # Je kunt later andere variabelen gebruiken zoals land_is of fertility
#         if agent.wood_standingStock > 0:
#             # Bossig land (groen)
#             color = "#006400"  # Donkergroen
#         else:
#             # Open land (bruin)
#             color = "#CD853F"  # Lichtbruin
#
#         return {
#             "Shape": "rect",  # Patches zijn vierkant
#             "Color": color,
#             "Filled": "true",
#             "Layer": 0,
#             "w": 1,  # Volledige breedte
#             "h": 1  # Volledige hoogte
#         }
#     return {}  # Retourneer een leeg dict voor onbekende agents
#
#
# # Visualisatie-elementen
# grid = CanvasGrid(agent_portrayal,
#                   grid_width=50, grid_height=50, canvas_width=500, canvas_height=500)
#
# chart = ChartModule([{"Label": "total_food_stock", "Color": "green"}], data_collector_name="datacollector")
#
# # # Visualisatie-elementen
# # grid = CanvasGrid(lambda agent: {"Shape": "circle", "Color": "red", "r": 0.8, "Layer": 0},
# #                   grid_width=50, grid_height=50, canvas_width=500, canvas_height=500)
# # chart = ChartModule([{"Label": "total_food_stock", "Color": "green"}], data_collector_name="datacollector")
#
# # Instelbare parameters
# model_params = {
#     "food_demand_pc": Slider("food_demand_pc", 1.15, 0.75, 1.45, 0.05, "Food Demand per Capita"),
#     "wood_demand_pc": Slider("wood_demand_pc", 2.35, 1, 5, 0.05, "Wood Demand per Capita"),
#     "clay_demand_pc": Slider("clay_demand_pc", 6, 0, 10, 1, "Clay Demand per Capita"),
#     "active_percentage": Slider("active_percentage", 10, 0, 100, 1, "Active %"),
#     "agriculture_days": Slider("agriculture_days", 250, 120, 265, 5, "Agriculture Days"),
#     "grain_per_grain_yield": Slider("grain_per_grain_yield", 6, 2, 6, 0.5, "Grain per Grain Yield"),
#     "regeneration_time": Slider("regeneration_time", 2, 1, 3, 1, "Regeneration Time"),
#     "kgs_wood_per_kg_clay": Slider("kgs_wood_per_kg_clay", 0.29, 0.14, 0.39, 0.05, "Kgs Wood per Capita"),
#     "clay_threshold": Slider("clay_threshold", 0.5, 0.3, 0.5, 0.05, "clay threshold"),
#     "territory": Slider("territory", 50, 0, 200, 1, "territory"),
#     "bad_harvest_interval": Slider("bad_harvest_interval", 5, 1, 10, 1, "Bad harvest interval"),
#     "forest_regrowth_lag": Slider("forest_regrowth_lag", 6, 3, 10, 1, "Forest regrowth lag"),
#     "time_limit": Slider("time_limit", 1000, 0, 3000, 1, "Time limit"),
#     "landuse_visualization": Checkbox("landuse_visualization", True, "landuse visualization"),
# }
#
# server = ModularServer(SAGAscapeModel, [grid, chart], "Community Simulation", model_params)
# server.port = 8521
#
# def launch():
#     server.launch()
